...
class StartActivity : SoundboardActivity() {
    ...
    private fun createSecondCategory() = SoundboardCategory("Second", SoundItems().apply {
        for (i in 0..11) {
            add(SoundItem(R.drawable.bg_main, R.raw.example_sound, soundPool.load(this@StartActivity, R.raw.example_sound, 1)))
        }
    })
    ...
    private fun createThirdCategory(): SoundboardCategory {
        val soundItems = SoundItems()
        for (i in 0..5) {
            soundItems.add(SoundItem(R.drawable.bg_main, R.raw.example_sound, R.string.example_sound_name, soundPool.load(this, R.raw.example_sound, 1)))
        }
